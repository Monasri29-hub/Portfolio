    ...
    <div className="relative inline-block group">
      <style>{`
        .gen-btn {
          ...
          font-family: "Barlow", "Poppins", "Inter", "Segoe UI", sans-serif;
          font-size: 0.95em;
          font-weight: 500;
        ...
        @keyframes gen-focused-letter-anim {
          ...
          50% {
            transform: scale(1.1);
            filter: blur(2px) brightness(150%) drop-shadow(-10px 4px 4px hsl(var(--highlight-color-hue), 100%, 70%));
          }
        }
